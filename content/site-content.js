...
export const PROJECTS = deepFreeze([
  {
    ...
    pitch: "Centralized 225+ appraisal reports in a protected, map-first workspace for faster property research.",
    highlights: [
      "Search 225+ reports by map, address, square footage, and property details",
  ...
  },
  {
    ...
    description: "Creator research, review, and scheduling grounded in 770+ past posts.",
  ...
  },
  {
    ...
    pitch: "Connected marketplace research and operations across 200K+ listings, 2,000+ targets, 1,000+ sales, and US$4K+ in realized profit.",
    highlights: [
  ...
  },
  {
    ...
    description: "Scheduling, health checks, and clean recovery across 29 tracked workflows.",
    ...
    pitch: "Keeps 29 automation workflows on schedule while I sleep, launching work, verifying fresh completions, and recovering after failures.",
    highlights: [
      ...
      "Retries cleanly after crashes, outages, terminal exits, and machine restarts; validated across 70+ fault scenarios"
    ],
